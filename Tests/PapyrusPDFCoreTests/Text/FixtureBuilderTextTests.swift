...
///
/// `PapyrusPDFTestSupportTests`가 아니라 여기 두는 이유: FB1·FB2는 `PapyrusPDFCore`의
/// `CMapParser`/`LZWDecode`로 재검증해야 하는데 `PapyrusPDFTestSupportTests`는
/// `PapyrusPDFTestSupport`에만 의존하고 `PapyrusPDFCore`에는 의존하지 않는다(Package.swift) —
